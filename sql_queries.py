...
time_table_create = ("CREATE TABLE IF NOT EXISTS time (start_time timestamp, hour varchar, day varchar, week varchar, month varchar, year varchar, weekday varchar)")
